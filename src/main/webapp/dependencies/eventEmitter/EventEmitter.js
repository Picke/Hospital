//HMS Note - EventEmitter v4.1 is incompatible with the way EventEmitter is implemented
//   in our codebase. In v3.1.4, scoping of events is global, versus v4.1.0 is scoped
//  to each instance of a the EventEmitter (with each HMS.Views.BaseView)
/**
 * EventEmitter v3.1.4
    ...
    EventEmitter.prototype.addListener = function(type, listener, scope, once) {
        ...
        if(this._maxListeners && !this._events[type].warned && this._events[type].length > this._maxListeners) {
            ...
            if(typeof console !== 'undefined') {
                console.warn('Possible EventEmitter memory leak detected. ' + this._events[type].length + ' listeners added for '+ type +'. Use emitter.setMaxListeners() to increase limit.');
            }
